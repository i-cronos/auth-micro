...
@Slf4j
public class CustomerFailureAuthenticationSuccessHandler implements AuthenticationFailureHandler {
    private final CoreJsonUtil coreJsonUtil;

    public CustomerFailureAuthenticationSuccessHandler(CoreJsonUtil coreJsonUtil) {
